...
const Gods = ({ navigation }) => {
    ...
    const getImage = () => {
        if (godName === 'Zeus') {
            return <Image source={{ uri: 'asset:Gods/Zeus.png' }} style={styles.image} />
        } else if (godName === 'Poseidon') {
            return <Image source={{ uri: 'asset:Gods/Poseidon.png' }} style={styles.image} />
        } else if (godName === 'Hades') {
            return <Image source={{ uri: 'asset:Gods/Hades.png' }} style={styles.image} />
        } else if (godName === 'Aphrodite') {
            return <Image source={{ uri: 'asset:Gods/Aphrodite.png' }} style={styles.image} />
        } else if (godName === 'Athena') {
            return <Image source={{ uri: 'asset:Gods/Athena.png' }} style={styles.image} />
        } else if (godName === 'Haephestus') {
            return <Image source={{ uri: 'asset:Gods/haephaestus.png' }} style={styles.image} />
        }
    }
    ...
    return (
        <View style={styles.container}>
            {godName === 'Zeus' ?
                <Image source={{ uri: 'asset:Gods/Zeus.png' }} style={styles.image} /> :
                godName === 'Poseidon' ?
                    <Image source={{ uri: 'asset:Gods/Poseidon.png' }} style={styles.image} /> :
                    godName === 'Hades' ?
                        <Image source={{ uri: 'asset:Gods/Hades.png' }} style={styles.image} /> :
                        godName === 'Aphrodite' ?
                            <Image source={{ uri: 'asset:Gods/Aphrodite.png' }} style={styles.image} /> :
                            godName === 'Athena' ?
                                <Image source={{ uri: 'asset:Gods/Athena.png' }} style={styles.image} /> :
                                <Image source={{ uri: 'asset:Gods/haephaestus.png' }} style={styles.image} />
            }
